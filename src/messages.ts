export function html_text(new_password: string){
    return `<h1>HI</h1>
...
export const removed = 'Your data successfully have been removed from our data base';
export const added = 'Your data has successfully have been added to data base';